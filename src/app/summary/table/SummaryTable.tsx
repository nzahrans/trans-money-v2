    ...
    <div className="w-full flex flex-col gap-6">
      <div className="flex items-start justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap w-full sm:w-auto">
          ...
          />
          <select
            className="border border-slate-200 dark:border-sky-700/30 bg-white dark:bg-[#0A1628] px-3 py-2 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 text-slate-900 dark:text-slate-100 shadow-sm"
            value={filter}
